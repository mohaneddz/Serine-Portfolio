    ...
    <div className="full min-h-screen relative pt-24 pr-8">
      ...
      <div className="w-full grid grid-cols-4 gap-8 ">
        <Link href="/logofolio/1">
          <WebImage id={6} image={image + '1/1.png'} hover />
        </Link>
        <Link href="/logofolio/2">
          <WebImage id={7} image={image + '2/1.png'} hover />
        </Link>
        <Link href="/logofolio/3">
          <WebImage id={8} image={image + '3/1.png'} hover />
        </Link>
        <Link href="/logofolio/4">
          <WebImage id={9} image={image + '4/1.png'} hover />
        </Link>
        <Link href="/logofolio/5">
          <WebImage id={10} image={image + '5/1.png'} hover />
        </Link>
      </div>
